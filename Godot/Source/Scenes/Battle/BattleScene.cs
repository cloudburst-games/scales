...
public partial class BattleScene : Node, ISceneTransitionable
{
    ...
    private async void OnVictoryStoryFinished(int level)
    {
        ...
        _lvlToLoad.GetNode<AudioContainer>("AudioContainer").Play();
    ...
    private void OnBtnIntroPressed()
    {
        ...
        _lvlToLoad.GetNode<AudioContainer>("AudioContainer").Pause();
        // TESTING
        // OnBattleEnded(true);
        //
    }
