...
public partial class BtnActions : TextureButton
{
    ...
    public override void _Ready()
    {
        ...
        _spellTextures = new Dictionary<SpellEffectManager.SpellMode, Texture2D[]>
        {
            ...
            },
            {
                ...
                {
                    GD.Load<Texture2D>("res://Assets/Graphics/Icons/IconNormal/SpellbookSmallAlt.png"),
                    GD.Load<Texture2D>("res://Assets/Graphics/Icons/IconNormal/SpellbookSmallAltHover.png"),
                    GD.Load<Texture2D>("res://Assets/Graphics/Icons/IconNormal/SpellbookSmallAltPressed.png")
                }
            }
        };
    ...
    // private SpellEffectManager.SpellMode _activeSpell = SpellEffectManager.SpellMode.None;
